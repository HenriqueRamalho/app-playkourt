...
function courtToForm(court: CourtDTO): EditCourtForm {
  return {
    name: court.name, sportType: court.sportType,
    description: court.description ?? '', pricePerHour: court.pricePerHour, isActive: court.isActive,
  };
}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="border-t border-gray-100 pt-2">
              <label className="flex items-center gap-3 cursor-pointer">
                <input type="checkbox" name="isActive" checked={form.isActive} onChange={handleChange} className="w-4 h-4 rounded border-gray-300 text-green-600 focus:ring-green-500" />
                <div>
